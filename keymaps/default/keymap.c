...
#define CTL_BSLS LCTL_T(KC_BSLS)
// END 🏠️ Home row mods -------------------------------------//
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUMSYM] = LAYOUT(
		...
		KC_TRNS, KC_TILD, KC_UNDS, KC_MINS, KC_SLSH, KC_COLN, KC_SLSH, KC_SCLN, KC_BSLS, KC_PLUS, KC_COMMA, KC_DOT, KC_DEL, KC_UP, KC__VOLDOWN, 
